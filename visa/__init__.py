...
class APIRequestor(object):
  ...
  def handleUrlfetchError(self, e, abs_url):
    if isinstance(self, urlfetch.InvalidURLError):
      msg = "The VISA library attempted to fetch an invalid URL (%r).  This is likely due to a bug in the VISA Python bindings.  Please let us know at support@visa.com." % (abs_url, )
